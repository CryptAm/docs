---
title: "Контракты для практических заданий"
description: Список верифицированных контрактов для модульного тестирования упражнений Base Learn.
---

Во многих разделах Base Learn содержатся упражнения для проверки ваших знаний по только что пройденному материалу. Мы говорим вам что нужно сделать, но не **как**. Вам предстоит применить полученные знания и продемонстрировать освоенные навыки.

В случае успеха вы получите нетрансферабельный, или Soulbound, NFT в качестве памятного знака о вашем обучении. Вы можете отслеживать свой прогресс на [progress page].

Ниже приведен список упражнений с ссылками на просмотр их кода. Модульные тесты написаны на собственном фреймворке на Solidity, но паттерны будут узнаваемы большинству инженеров.
